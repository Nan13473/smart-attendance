...
- **QR Code Attendance *(Additive feature)*:** Students will be able to mark their own attendance by scanning a session-specific QR code generated by the professor. This is an **addition** to the existing manual marking system — professors will still be able to take and edit attendance manually as they do today.
...
- **Professor can manually edit attendance:** After loading a session, professors can directly toggle each student's status (Present/Absent) and save corrections at any time.
